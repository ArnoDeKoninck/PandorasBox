//import { Action, Classes, DamageTypes, Spell } from "../types/GlobalTypes";
import { Item } from "../types/ItemTypes";

export const levelOneSpells: Item[] = [
	/*{
		name: "Absorb Elements",
		requirements: [
			{
				s: true,
				other: `When taking ${DamageTypes.ACID}, ${DamageTypes.COLD}, ${DamageTypes.FIRE}, ${DamageTypes.LIGHTNING}, ${DamageTypes.THUNDER} Damage.`,
	...
	{
		name: "Guiding Hand",
		link: "http://dnd5e.wikidot.com/spell:guiding-hand",
	},
	{
		name: "Hail of Thorns",
	...
	{
		name: "Healing Elixir",
		link: "http://dnd5e.wikidot.com/spell:healing-elixir",
	},
	{
		name: "Healing Word",
	...
	{
		name: "Hellish Rebuke",
		link: "http://dnd5e.wikidot.com/spell:healing-rebuke",
	},
	{
		name: "Heroism",
	...
	},
	{
		...
		link: "http://dnd5e.wikidot.com/spell:jims-magic-missle",
	},
	{
		name: "Jump",
