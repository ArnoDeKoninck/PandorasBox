...
export const CR_OutsideLocations: PointOfIntrest[] = [
	...
	},
	{
		...
		events: [
			<li key={uuid()}>on inspection: A flash of lightning illuminates the dismal village of Barovia, its rooftops visible above a smothering blanket of fog one thousand feet below.</li>,
			<li key={uuid()}>If they have 15 passive perception: Underneath the platform on which you stand, about one hundred feet down, a stone construction protrudes from the cliff face. Three dirt-caked windows are set into it.</li>,
		],
	},
	{
		name: "Entry",
